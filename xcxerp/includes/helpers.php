...
function code2Session($js_code = null)
{
    if($js_code)
    { 
        $url = "https://api.weixin.qq.com/sns/jscode2session?appid=wx470e35b6fb7b3049&secret=848427cdbdf8a260e3f07e9c1edde760&js_code=$js_code&grant_type=authorization_code";
